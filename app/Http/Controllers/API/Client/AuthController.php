...
class AuthController extends AppBaseController
{
    ...
    public function login(LoginAPIRequest $request): JsonResponse
    {
        ...
        $userTokensCount = $user->tokens()->where('created_at', '>', now()->subMinutes(config('sanctum.expiration')))->count();
        if ($userTokensCount > User::NO_OF_DEVICE_ALLOWED) {
            throw new LoginFailedException('You\'ve reached your device limit');
        }
