...
class User extends Authenticatable implements HasMedia
{
    ...
    public const MAX_LOGIN_RETRY_LIMIT = 5;
    public const LOGIN_REACTIVE_TIME = 1;
    ...
    public const LOGIN_ACCESS = [
        'User' => [self::PLATFORM['DEVICE'], self::PLATFORM['CLIENT'], self::PLATFORM['ADMIN']],
        'Admin' => [self::PLATFORM['ADMIN'], self::PLATFORM['CLIENT']],
    ];

    public const NO_OF_DEVICE_ALLOWED = 2;
